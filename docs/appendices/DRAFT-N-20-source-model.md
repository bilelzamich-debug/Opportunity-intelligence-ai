...
> **Ratification notice.** `AGENT-PLAYBOOK` **F6**: "🔺 tasks require explicit
> human sign-off. Always." This record is prepared, not adopted. `T02.1.1`
> carries ⚠. It must not be treated as binding until a human ratifies it.
